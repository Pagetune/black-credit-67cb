...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/black-credit-67cb
```

A live public deployment of this template is available at [https://black-credit-67cb.templates.workers.dev](https://black-credit-67cb.templates.workers.dev)
